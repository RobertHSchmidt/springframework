...
public class ConfigurationPostProcessorTests extends TestCase { 
	...
	public void testPointcut() {
		...
		assertEquals("No advisors put in factory", 0, bf
				.getBeanNamesForType(Advisor.class).length);
		...
		assertFalse("No pointcut in factory: method was protected (hidden)", 
				bf.containsBean("debugAdvice"));
	}
	...
	public void tstLocalAndExternalAspects() throws Exception {
		ClassPathXmlApplicationContext bf = new ClassPathXmlApplicationContext(
