 ...
 */
package org.springframework.config.java.context.java;
...
import org.springframework.config.java.beans.factory.java.ConfigurationPostProcessor;
import org.springframework.config.java.beans.factory.support.AbstractClassScanningBeanDefinitionReader;
import org.springframework.config.java.beans.factory.support.ConfigurationClassScanningBeanDefinitionReader;
 ...
 * @author Costin Leau
 * 
 * @see org.springframework.config.java.beans.factory.support.DefaultListableBeanFactory
 */
public abstract class AbstractAnnotationApplicationContext extends AbstractRefreshableApplicationContext {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.springframework.config.java.context.support.AbstractRefreshableApplicationContext#loadBeanDefinitions(org.springframework.config.java.beans.factory.support.DefaultListableBeanFactory)
	 */
	@Override
