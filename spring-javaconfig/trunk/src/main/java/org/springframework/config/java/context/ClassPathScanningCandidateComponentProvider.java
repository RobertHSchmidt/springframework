 ...
 */
class ClassPathScanningCandidateComponentProvider implements ResourceLoaderAware {
	 ...
	 * {@link Service @Service}, and {@link Controller @Controller} stereotype
	 * annotations.
	...
	/**
	 * Set the ResourceLoader to use for resource locations. This will typically
	 * be a ResourcePatternResolver implementation.
	 * <p>
	 * Default is PathMatchingResourcePatternResolver, also capable of resource
	...
	/**
	 * Register the default filter for {@link Component @Component}. This will
	 * implicitly register all annotations that have the
	...
	/**
	 * Scan the class path for candidate classes.
	 * @param basePackage the package to check for annotated classes
	 * @return a corresponding Set of Classes that are annotated as Component
	 * (or any annotation annotated as Component)
	 */
	 ...
	 * <p>
	 * The default implementation checks whether the class is concrete (i.e. not
	 * abstract and not an interface). Can be overridden in subclasses.
