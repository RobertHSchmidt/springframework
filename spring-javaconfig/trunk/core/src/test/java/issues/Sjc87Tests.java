...
import org.springframework.config.java.factory.support.ReflectiveJavaConfigBeanDefinitionReader;
...
public abstract class Sjc87Tests {
	...
	public @Test void populateAndRenderModel() {
		...
		JavaConfigBeanFactory bf = new DefaultJavaConfigBeanFactory(extBf, new DefaultBeanFactoryProvider());
