...
import static org.springframework.config.java.internal.model.AspectClassTests.VALID_ASPECT_CLASS;
	...
	public @Test void validateAbstractConfigurationsNotValid() {
		ConfigurationClass configClass =
			new ConfigurationClass("a", Modifier.ABSTRACT)
				.add(new BeanMethod("m"));
		assertErrorsContains(configClass, ABSTRACT_CONFIGURATION_MUST_DECLARE_AT_LEAST_ONE_EXTERNALBEAN_EXTERNALVALUE_OR_AUTOBEAN);
	}
