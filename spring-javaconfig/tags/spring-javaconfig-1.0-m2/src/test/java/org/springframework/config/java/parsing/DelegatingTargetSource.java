...
/**
 * TargetSource that delegates to an arbitrary named bean at runtime, performing
 * lookup just before invocation. Allows late binding of an object when building
 * a bean factory. <br>
 * Not currently used.
 * 
 * @author Rod Johnson
