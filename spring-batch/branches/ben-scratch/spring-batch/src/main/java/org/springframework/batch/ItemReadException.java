...
/**
 * The exception thrown any time an error happens while reading items. This exception is not
 * generally fatal and may be able to be safely ignored.
 * 
 * @author Ben Hale
 */
public class ItemReadException extends Exception {
	...
	/**
	 * Constructs a new {@link ItemReadException} with the specified detail message. The cause is
	...
	/**
	 * Constructs a new {@link ItemReadException} with the specified detail message and cause.
	 * <p>
