...
/**
 * Simple implementation of a conversation manager that stores conversations
 * in the session attribute map.
 * 
...
public class SimpleConversationManager implements ConversationManager {
	...
	/**
	 * Set the maximum number of allowed concurrent conversations. Set
	 * to -1 for no limit.
	 */
	 ...
	 * container and add it to the session if no existing container can be found.
	 */
	...
	private static class ConversationContainer implements Serializable {
		 ...
		 * @param maxConversations the maximum number of allowed concurrent conversations,
		 * -1 for unlimited
		 */
